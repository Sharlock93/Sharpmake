...
@"  <PropertyGroup Condition=""'$(Configuration)|$(Platform)'=='[conf.Name]|[platformName]'"" Label=""Configuration"">
    ...
    <GradleOutputDir>$(OutDir)</GradleOutputDir>
  </PropertyGroup>
";
...
@"    <GradlePackage>
        ...
        <ApkFileName>$(TargetName)$(TargetExt)</ApkFileName>
        <GradlePlugin>[gradlePlugin]</GradlePlugin>
        <GradleVersion>[gradleVersion]</GradleVersion>
        <AndroidAppLibName>[gradleAppLibName]</AndroidAppLibName>
      </GradlePackage>
";

                public static string GradleBuildBat =
@"REM Automatically Generated by Sharpmake don't edit.
if [%1] == [-p] (
[sdkRoot]\build-tools\[buildToolsVersion]\aapt.exe package -f -M [androidManifestPath] -I [sdkRoot]\platforms\[apiVersion]\android.jar -F [outputPath]_ [assetPaths] %~ndp2\src\main\
[javaHome]\jarsigner.exe -storepass android [outputPath]_ androiddebugkey
[sdkRoot]\build-tools\[buildToolsVersion]\zipalign.exe -f 4 [outputPath]_ [outputPath]
del [outputPath]_
)
";
            }
